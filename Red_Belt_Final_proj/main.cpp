...
void HardTest(){
    ...
    for(size_t i = 0; i < documents_number; i++){
        string new_line;
        for(size_t j = 0; j < words_in_document_number; j++){
            new_line += ' ';
            new_line += to_string(j);
        }
        documents.push_back(new_line);
    }

    for(size_t i = 0; i < queries_count; i++){
        string new_line;
        for(size_t j = 0; j < words_in_a_query; j++){
            new_line += ' ';
            new_line += to_string(j);
        }
    ...
    TestFunctionality(documents,queries,expected);
};
